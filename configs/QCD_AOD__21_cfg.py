...
f = open('./myLowPtGsfElectronsAnalyzer/macros/fileLists/QCD_AOD/QCD_AOD__21.txt','r')
...
process.TFileService = cms.Service("TFileService",
                                       fileName = cms.string('root://cmseos.fnal.gov//store/user/nbower/plots/QCD_LowPT/QCD_AOD__21.root')
                                   )
