...
f = open("/uscms_data/d3/nbower/FSU/TestLowPt/CMSSW_10_6_12/src/myLowPtGsfElectronsAnalyzer/myLowPtGsfElectronsAnalyzer/macros/fileLists/fileList.txt","r")
...
process.TFileService = cms.Service("TFileService",
                                       fileName = cms.string('h_ALP_M10ID_Hists.root')
                                   )
